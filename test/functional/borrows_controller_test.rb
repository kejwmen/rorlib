...
class BorrowsControllerTest < ActionController::TestCase
  ...
  test "should create borrow" do
    assert_difference('Borrow.count') do
      post :create, borrow: { book_id: @borrow.book_id, date_return: @borrow.date_return, user_id: @borrow.user_id }
    end
  ...
  test "should update borrow" do
    put :update, id: @borrow, borrow: { book_id: @borrow.book_id, date_return: @borrow.date_return, user_id: @borrow.user_id }
    assert_redirected_to borrow_path(assigns(:borrow))
  end
